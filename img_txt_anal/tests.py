...
from .models import Docs, UsersToDocs, Cart
...
class ViewsTestCase(TestCase):
    def setUp(self):
        ...
        self.test_doc = Docs.objects.create(file_path='test/path/to/file.png', size=12345, external_id=1, file_type='png')
    ...
    def test_analyse_doc_view(self):
        doc = Docs.objects.create(file_path="test_path", external_id=999, size=250, file_type="text/plain")
